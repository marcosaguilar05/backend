...
import presupuestosMantenimientoRoutes from './routes/presupuestos-mantenimiento.routes';
...
app.use('/api/presupuestos-mantenimiento', presupuestosMantenimientoRoutes);
